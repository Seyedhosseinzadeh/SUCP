            ...
            for fid in social_relations[uid]:
                if uid < fid:
                    ...
                    jaccard_check_in = (1.0 * len(u_check_in_neighbors.intersection(f_check_in_neighbors)) /
                                        (len(u_check_in_neighbors.union(f_check_in_neighbors)) + 1.0))
                    # print(1.0 * len(u_check_in_neighbors.intersection(f_check_in_neighbors)))
                    # print(len(u_check_in_neighbors.union(f_check_in_neighbors)) + 1.0)
